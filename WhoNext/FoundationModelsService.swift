        ...
        AsyncStream { continuation in
            ...
            Task {
                ...
                do {
                    ...
                    print("❌ [FoundationModels] Streaming error: \(error)")
                    isResponding = false
                }
...
final class MeetingCalendarTool /* : Tool */ {
    ...
    nonisolated func call(arguments: Arguments) async throws -> String {
        ...
        🕐 Start: \(dateFormatter.string(from: eventDate))
        🕑 End: \(dateFormatter.string(from: endDate))
        👥 Attendees (\(arguments.attendees.count)): \(arguments.attendees.joined(separator: ", "))
